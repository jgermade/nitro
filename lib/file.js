...
var file = {
  ...
  read: function (callback) {
    return (callback ? fs.readFile : fs.readFileSync)( joinPaths.root.apply(this, arguments), { encoding: 'utf8' }, callback);
  },
  readJSON: function () {
  ...
  write: function (paths, content, options, callback) {
    ...
    if( callback instanceof Function ) {
      ...
      return fs.writeFile( joinPaths.root(dest) , content, _.extend({ encoding: 'utf8' }, options || {}, callback) );
    } else {
      if( filepath ) mkdirp.sync(filepath);
