...
Object.defineProperty(File.prototype, 'path', {
  get: function () {
    return joinPaths( this.filepath || '.', this.filename );
  },
...
Object.defineProperty(File.prototype, 'full_path', {
  get: function () {
    return joinPaths.root( this.cwd, this.path );
  }
});

Object.defineProperty(File.prototype, 'full_dir', {
  get: function () {
    return joinPaths.root( this.cwd, this.filepath );
  }
});
...
['src', 'path', 'map'].forEach(function (property) {
  ...
  File.prototype['set' + property_title_case] = function (src) {
...
File.prototype.load = function (fpath) {
  ...
  var cwd = this.cwd;
  cwd = /^\//.test(cwd) ? cwd : joinPaths(process_cwd, cwd);

  this.src = file.read( joinPaths(cwd, this.path ) );
