    ...
    release: function (releaseName) {
      ...
      fetch(releasesUrl, {
          headers: {
            ...
            'Authorization': 'token b0e9c011b53e62209168e0a2cb82f580cf5727f5'
          }
        })
        .then(function(res) {
      ...
      .then(function (release) {
        ...
        console.log(`https://uploads.github.com/repos/${remote.owner}/${remote.repo}/releases/${release.id}/assets?name=test.js`);

        return fetch(`https://uploads.github.com/repos/${remote.owner}/${remote.repo}/releases/${release.id}/assets?name=test.js`, {
            method: 'POST',
            body: body,
            headers: {
              'Accept': 'application/vnd.github.v3+json',
