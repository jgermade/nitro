...
module.exports = function (nitro) {
  ...
  function expandDependencies (dependencies, options, found, map) {
    ...
    var meta = dependencies.pkg.meta,
        filter = options.filter || function (dependenceName, version) { return true };
  ...
  Dependencies.prototype.expand = function (inCascade, options) {
    ...
    if( typeof inCascade === 'boolean' ) {
      options = options || { inCascade: inCascade };
    } else {
      options = inCascade || {};
    }

    options.filter = options.filter || (options.only && function (dependenceName, version) {
